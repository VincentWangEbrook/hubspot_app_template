        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Ebrook SaaS</span>
            </div>
      ...
      <section className="relative overflow-hidden pt-20 pb-28 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
            专为多租户 SaaS 打造的企业级 HubSpot 集成方案。
            实现联系人、公司数据的双向实时同步，赋能您的业务增长。
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Ebrook SaaS</h3>
              <p className="text-gray-500 max-w-xs">
                致力于为企业提供最优质的 SaaS 集成解决方案，连接您的每一个业务环节。
              </p>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Ebrook Group. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
